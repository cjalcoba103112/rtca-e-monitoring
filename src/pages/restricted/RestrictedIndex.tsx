...
// import SchoolingSaveModal from "./RestrictedSaveModal";
import { formatDaysToYMD } from "../../utils/formatDaysToYMD";
import RestrictedSaveModal from "./RestrictedSaveModal";
...
const RestrictedIndex: React.FC = () => {
    ...
    const {
        ...
        queryKey: ["restricted", selectedStatus],
    ...
    return (
        <div>
            ...
            <Table
                ...
                dataSource={
                    filteredData.length
                        ? filteredData.filter((c) => c.status != "Pending Approval" && c.activityType?.activityTypeName == "RESTRICTED")
                        : activities.filter((c) => c.status != "Pending Approval" && c.activityType?.activityTypeName == "RESTRICTED")
                }
