...
import { Form, Input, Modal, Select, Typography, Spin, type FormInstance } from "antd";
// ... (other imports)
    ...
    return (
        ...
        >
            <Form form={form} initialValues={selectedActivity || emptyValues} layout="vertical">
                ...
                >
                    <Select placeholder="Select Activity Type" disabled allowClear value={activityTypes?.[0]?.activityTypeId}>
                        {activityTypes.map((a) => (
