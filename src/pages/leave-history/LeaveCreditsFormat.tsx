...
export default function LeaveCreditsFormat({ selectedPersonnel }: LeaveCreditsFormatType) {
    ...
    const handleOk = async () => {
        ...
        try {
            ...
            (Object.keys(selectedPersonnel) as (keyof typeof selectedPersonnel)[]).forEach((key) => {
            ...
            if (selectedPersonnel?.personnelId) {
                ...
                const updatedPersonnel = await personelService.update(formData, selectedPersonnel?.personnelId);
                    ...
                    >
                        <div className="flex">
                            <Button htmlType="button" loading={uploading}>
                                {uploading ? "Uploading..." : <> <UploadOutlined /> Upload</>}
                            </Button>
