...
import SchoolingSaveModal from "./SchoolingSaveModal";
...
const SchoolingIndex: React.FC = () => {
    ...
    const {
        ...
        queryKey: ["schooling", selectedStatus],
    ...
    return (
        <div>
            ...
            <Table
                ...
                dataSource={
                    filteredData.length
                        ? filteredData.filter((c) => c.status != "Pending Approval" && c.activityType?.activityTypeName == "SCHOOLING")
                        : activities.filter((c) => c.status != "Pending Approval" && c.activityType?.activityTypeName == "SCHOOLING")
                }
